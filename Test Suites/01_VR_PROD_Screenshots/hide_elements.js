...
var element = document.getElementsByClassName('localisation-sticky')[0]; if (element !== 'undefined' && element !== null && !!element && element.length > 0) {element.parentNode.removeChild(element);}

// hide element logo meine bank
var element = document.getElementsByClassName('logo-meine-bank__wrapper')[0]; if (element !== 'undefined' && element !== null && !!element && element.length > 0) {element.style.display = 'none';}

// remove/delete element seiten anfang button
var element = document.getElementsByClassName('top-link')[0]; if (element !== 'undefined' && element !== null && !!element && element.length > 0) {element.parentNode.removeChild(element);}

var element = document.getElementsByClassName('campaign-area')[0]; if (element !== 'undefined' && element !== null && !!element && element.length > 0) {element.style.display = 'none';}
...
var element = document.getElementsByClassName('module stickynav')[0]; if (element !== 'undefined' && element !== null && !!element && element.length > 0) {element.parentNode.removeChild(element);}

var element = document.getElementsByClassName('module module-external ym-clearfix')[0]; if (element !== 'undefined' && element !== null && !!element && element.length > 0) {element.parentNode.removeChild(element);}
...
// remove all iframes
var element = document.querySelectorAll('iframe'); if (element !== 'undefined' && element !== null && !!element && element.length > 0) {element.forEach(function(e, index, array) {e.parentNode.removeChild(e);})}
...
var element = document.getElementsByClassName('vvClose')[0]; if (element !== 'undefined' && element !== null && !!element && element.length > 0) {element.click();}

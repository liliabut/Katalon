...
WebUI.setText(findTestObject('08VR/Page_Privatkunden - Volksbanken Rai/input_dest'), '012345678900')
...
WebUI.click(findTestObject('08_gasf/Page_Privatkunden - Volksbanken Rai/button_OK'))

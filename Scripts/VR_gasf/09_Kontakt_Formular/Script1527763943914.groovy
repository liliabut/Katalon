...
WebUI.scrollToElement(findTestObject('09_gasf/Page_Privatkunden - Volksbanken Rai/a_Kontakt  Filialen'), 0)

WebUI.delay(2)

WebUI.mouseOver(findTestObject('09_gasf/Page_Privatkunden - Volksbanken Rai/a_Kontakt  Filialen'))

WebUI.delay(2)

WebUI.click(findTestObject('09_gasf/Page_Privatkunden - Volksbanken Rai (2)/a_Kontakt aufnehmen'))

...
WebUI.click(findTestObject('03_gasf/Page_Ausfall des Unternehmers - Vol (1)/a_Zugriff aufPasswrter'))

WebUI.click(findTestObject('03_gasf/Page_Ausfall des Unternehmers - Vol (1)/a_Vertretung organisieren'))

WebUI.click(findTestObject('03_gasf/Page_Ausfall des Unternehmers - Vol (1)/a_Vollmachten einrichten'))

WebUI.click(findTestObject('03_gasf/Page_Ausfall des Unternehmers - Vol (1)/a_Krankheit und Berufsunfhigke'))

...
WebUI.navigateToUrl('http://kundentest.dev-unitb.de/ogrhtmlprototyp/ogrhtmlprototyp_18.1/filialsuche-textinput.html')

WebUI.delay(5)

WebUI.setText(findTestObject('34TF/Page_Filialsuche-textinput - BVR HT/input_city'), 'berlin')

...
WebUI.navigateToUrl('rc-ogrhtmlprototyp.testintern/18-1-1/filialsuche-nuernberg-textinput.html')
...
WebUI.verifyTextNotPresent('Willy-Brandt-Platz 8', false)
...
WebUI.verifyTextNotPresent('Martin-Luther-Platz 20', false)
...
WebUI.verifyTextNotPresent('Wölfelstraße 7', false)
...
WebUI.verifyTextNotPresent('Hauptwachstr. 11', false)

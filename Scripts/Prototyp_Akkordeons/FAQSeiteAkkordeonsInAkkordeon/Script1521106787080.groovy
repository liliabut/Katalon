...
WebUI.verifyMatch(WebUI.getAttribute(findTestObject('AkkordeonFAQXpath/Akkordeon02Active'), 'aria-expanded'),
	'true', false)
...
WebUI.verifyMatch(WebUI.getAttribute(findTestObject('AkkordeonFAQXpath/Akkordeon03Active'), 'aria-expanded'),
	'true', false)
...
WebUI.verifyMatch(WebUI.getAttribute(findTestObject('AkkordeonFAQXpath/Akkordeon0Active'), 'aria-expanded'),
	'true', false)
...
WebUI.verifyMatch(WebUI.getAttribute(findTestObject('AkkordeonFAQXpath/Akkordeon05Active'), 'aria-expanded'),
	'true', false)

...
// open list of URLs
fromFile = RunConfiguration.getProjectDir() + GlobalVariable.urls_list_mobile
...
while ((url = br.readLine()) != null) {
	...
	Screenshot screenshot = new AShot().shootingStrategy(ShootingStrategies.viewportRetina(100,0,0,3)).takeScreenshot(driver)

...
WebUI.navigateToUrl('http://rc-ogrhtmlprototyp.testintern/18-2-0/filialsuche-wangen.html')
...
WebUI.scrollToElement(findTestObject('40_TF/Page_Filialsuche-wangen - BVR HTML/div_Brtlingen'), 0)
...
WebUI.scrollToElement(findTestObject('40_TF/Page_Filialsuche-wangen - BVR HTML/div_Uhingen'), 0)

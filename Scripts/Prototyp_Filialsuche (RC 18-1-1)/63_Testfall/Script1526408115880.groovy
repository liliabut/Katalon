...
WebUI.navigateToUrl('http://rc-ogrhtmlprototyp.testintern/18-1-1/filialsuche-rotenburg-textinput.html')
...
WebUI.click(findTestObject('OGRPrototypFilialsuche - DistanzRotenburg/2teSeite - Copy'))
...
WebUI.verifyElementText(findTestObject('OGRPrototypFilialsuche - DistanzRotenburg/08ErgebnisTest'), 'VR-Bankverein Bad Hersfeld-Rotenburg eG SB-Stelle Bebra')

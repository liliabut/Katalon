...
WebUI.navigateToUrl('http://rc-ogrhtmlprototyp.testintern/18-1-0/geldautomatensuche-goeppingen.html')

WebUI.delay(5)

WebUI.scrollToElement(findTestObject('002/Page_Filialsuche-rotenburg - BVR HT/svg_dropdown-icons'), 0)

WebUI.click(findTestObject('002/Page_Filialsuche-rotenburg - BVR HT/svg_dropdown-icons'))

WebUI.delay(2)

WebUI.scrollToElement(findTestObject('Goeppingen_option'), 0)

WebUI.mouseOver(findTestObject('Goeppingen_option'))

WebUI.delay(2)

WebUI.click(findTestObject('Goeppingen_option'))

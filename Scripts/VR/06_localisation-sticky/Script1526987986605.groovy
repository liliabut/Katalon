...
WebUI.click(findTestObject('06VR/Page_Filialsuche Privatkunden - Vol/a_Firmenkunden'))
...
WebUI.click(findTestObject('06VR/Page_Firmenkunden - Volksbanken Rai/a_Junge Kunden'))
...
WebUI.click(findTestObject('06VR/Page_Junge Kunden - Volksbanken Rai/a_Privatkunden'))

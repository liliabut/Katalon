...
ArrayList<WebElement> wes = WebUiCommonHelper.findWebElements(findTestObject('Akkordion_open'), 5)
...
if(wes.size > 1) {
	...
	String text = wes.get(0).getAttribute('innerHTML')
	
	if (!text.equalsIgnoreCase("Akkordeon 1")) {
		WebUI.comment("Nicht erster Akkordeon ist offen!")
		WebUI.closeBrowser()
		throw new StepFailedException("Nicht erster Akkordeon ist offen!")
	}	
}
